...
<head>
    ...
    <link rel="icon" href="bootstrap-5.3.1/favicon-1.png" type="image/png">
    <style>
    * {
...
<body>
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="https://github.com/metidev" target="_blank">
                <img src="bootstrap-5.3.1/favicon.png" alt="Logo" width="30" height="24"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" role="search">
                    ...
                    <div class="flexbox">
                        <div class="search">
                            <div>
                                <input tabindex="1" type="text" id="search" type="text" placeholder="Search . . ." required>
                            </div>
                        </div>
                    </div>
            </div>
    ...
    <div class="container">
        ...
        foreach ($temp as $Dir) {
          ...
          echo '<div class="col-md-4"><a href="http://' . $DomainPostFix . '/' . basename($Dir) . '"><span style="background: linear-gradient(90deg, ' . stringToColor(strtolower($FirstChar)). '7d' . ' 0%, ' . stringToColor(strtolower($FirstChar)) . ' 50%, rgba(0, 0, 0, 0) 99%);">' . $FirstChar . '</span>' . basename($Dir) . '</a></div>';
        }
        ?>
            </div>
            <div class="info"><br />
