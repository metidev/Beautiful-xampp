    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex" role="search">
          <input class="form-control me-2 search" tabindex="1" type="text" id="search" placeholder="Type To search..."
            aria-label="Search">
        </form>
      </div>
    </div>
    ...
    <div class="content">
      ...
      <div class="Directories row">
        ...
        foreach ($temp as $Dir) {
          ...
          echo '<div class="col-md-4"><a href="http://' . $DomainPostFix . '/' . basename($Dir) . '"><span style="background-color:' . stringToColor(strtolower($FirstChar)) . '">' . $FirstChar . '</span>' . basename($Dir) . '</a></div>';
        }
        ?>
      </div>
      <div class="info"><br />
